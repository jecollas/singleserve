...
var maxStat = Math.max(stats)
  ...
  function maxStat(stats) {
    var job = Math.max(...stats);
    return stats[job];
    switch(job) {
      case 'Barbarian':
      case 'Fighter':
        maxStat = document.getElementById('strength').innerHTML;
        break;
      case 'Monk':
      case 'Ranger':
      case 'Rogue':
        maxStat = document.getElementById('dexterity').innerHTML;
        break;
      case 'Wizard':
        maxStat = document.getElementById('intelligence').innerHTML;
        break;
      case 'Cleric':
      case 'Druid':
        maxStat = document.getElementById('wisdom').innerHTML;
        break;
      case 'Bard':
      case 'Paladin':
      case 'Sorcerer':
      case 'Warlock':
        maxStat = document.getElementById('charisma').innerHTML;
        break;
    }
  }

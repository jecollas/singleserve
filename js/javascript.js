...
var religion = [
  ...
  'The Weaver, Goddess of Corruption, Manipulation, Insects, and Spiders (CE)'
]
...
function newChar () {
  ...
  var trait = personality.trait
  var ideal = personality.ideal
  var bond = personality.bond
  var flaw = personality.flaw
  ...
  var extras = personality.extra

  if (extras != null) {
    personality.extra = randomString(extras)
    document.getElementById('extraDisplay').innerHTML = extras
  } else {
